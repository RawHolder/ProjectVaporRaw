...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "VaporBladeball V1.0\n\nEnjoy using the best BladeBall script that's out there right now!\n\nGet this script viral, make content and tag #ProjectVapor #VaporBladeBall"
    end
    task.wait()
    updateScrollSize()
end
