...
local function setTab(tabName)
    if tabName == "Changelog" then
        content.Text = "VaporGrowAGarden V1.0\n\n- Added Walkspeed Editor\n- Added Infinite Jump\n- Added NoClip\n- Added Fruit ESP\n- Added Select Fruits\n- Added Max Age & Oldest Age Indicators\n- Added Auto-Fling Intruders\n- Added Auto-Buy World Pets\n- Added Auto-Steal\n- Added Auto-Open Eggs, Crates & Seed Packs\n- Added Auto-Buy Gear\n- Added Auto-Claim Mailbox & Auto-Accept Gifts\n- Added Auto Server-Hop\n- Added Auto-Codes\n- Added FPS Boost\n- Added Discord Webhook Reports\n- Added Auto Farm System (buy, plant, harvest, sell, expand)\n- Added Auto-Buy Seeds\n- Added Auto-Sprinklers & Auto-Water\n- Added Auto-Skill Points\n- Added Auto-Equip Pets & Auto-Buy Pet Slots\n- Added Auto-Sell Pets\n- Added Auto-Harvest & Auto-Sell"
    end
    task.wait()
    updateScrollSize()
end
